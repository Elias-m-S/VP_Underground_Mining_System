...
/**
 * @brief Sets the digit which shall be displayed (buffered).
 * The real output is done in displayCycle() via multiplexing.
 *
 * @param outputDisplay Display to output to
 * @param digit The digit (0-9 and A-F) or DIGIT_...
 *
...
/**
 * @brief Cyclic display refresh (multiplexing).
 * Call this function periodically (recommended: 1ms task slot).
 *
 * @return Returns DISPLAY_ERR_OK if no error occured
 */
int32_t displayInitialize(void);
